  ...
  async addEvent(dataClient) {
    try {
      var event = new EventEntity({
        ...
        image_thumb: dataClient.img_thumb,
        image_banner: dataClient.img_banner,
        image_a_cert: dataClient.img_certificate,
      ...
      var result = await EventEntity.findByIdAndUpdate(
        id,
        {
          $set: {
            ...
            image_thumb: dataClient.img_thumb,
            image_banner: dataClient.img_banner,
            image_a_cert: dataClient.img_a_certificate,
            // image_v_cert: dataClient.img_v_certificate,
            imagePath: dataClient.imagePath,
            apiLink: dataClient.apiLink,
            isShow: dataClient.isShow,
